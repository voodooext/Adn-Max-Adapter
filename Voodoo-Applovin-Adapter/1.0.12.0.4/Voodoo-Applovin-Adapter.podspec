Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://voodoo-adn-framework.s3.eu-west-1.amazonaws.com/iOS/adapter/1.0.12.0.4/VoodooAdapter.zip'}
  s.source_files = 'VoodooAdapter/*.{h,m}'
  s.static_framework = true
  s.dependency 'VoodooAdn', '=1.0.12'
