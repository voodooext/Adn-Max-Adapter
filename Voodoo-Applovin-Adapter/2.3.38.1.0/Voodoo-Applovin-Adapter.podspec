Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'https://voodoo-adn-framework.s3.eu-west-1.amazonaws.com/iOS/maxads/adapter/2.3.38.1.0/VoodooMaxAdapter.zip'}
  s.source_files = 'VoodooMaxAdapter/*.{h,m}'
  s.static_framework = true
  s.dependency 'VoodooAdn', '=2.3.38'
